...
<table>
  ...
  <tbody>
    <tr>
      <td>1</td>
      <td>Define 10 divided by 7 in terms of the integer result and remainder</td>
      <td>
        \[
        10 \equiv 7(1) + 3
        \]
    ...
    <tr>
      <td>2</td>
      <td>Define the divisor (7) in terms of the remainder (3)</td>
      <td>
        \[
        7 \equiv 3(2) + 1
        \]
    ...
    <tr>
      <td>3</td>
      <td>Rearrange all equations in terms of the remainder</td>
      <td>
        \[
        \begin{align}
        3 &\equiv 10 - 7(1) \\
    ...
    <tr>
      <td>4</td>
      <td>Substitute equations to get one equation in terms of the original values (7 and 10)</td>
      <td>
        \[
        1 \equiv 7 - \left[ 10 - 7(1) \right](2)
        \]
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>6</td>
      <td>Rearrange and simplify 10(2) to 0</td>
      <td>
        \[
        \begin{align}
        1\cdot 7^{-1} &\equiv 3 \\
